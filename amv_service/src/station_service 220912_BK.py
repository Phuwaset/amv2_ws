        ...
        if len(data.poses) > 10 :
            ...
            if not self.cal_diff_x == 0:
                ...
                if self.cal_diff_x  < 0:
                    self.cal_angle = self.cal_angle *(-1)
                else 
                    self.cal_angle = self.cal_angle *(1)
            else:
             self.cal_angle = 0   
            ...
            #if self.check_movebase_status == 3:
            #    self.start_rotate = False
            #    self.start_rotate_cw = False
            #    self.start_rotate_ccw = False

            self.diff_angle = self.cal_angle - self.current_angle

                

            if self.start_rotate == False:

                if self.diff_angle > 1.2  or  self.diff_angle < -1.2 and self.check_diff_angle == False:
                    self.check_diff_angle = True
                if self.check_diff_angle == True:
                    if self.cal_angle > self.current_angle:
                        twist.linear.x = 0
                        twist.angular.z = 0.1
                        print ('ccw')
