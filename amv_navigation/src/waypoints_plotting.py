...
class WayPointPlotting():
    ...
    def add_waypoint_name(self, pose, name):
        ...
        waypoint_marker_name.scale.z = 0.5   #Text size
    ...
    def init_waypoint_markers(self):        
        ...
        self.waypoint_markers_circle.scale.x = 0.5   #Waypoint circle size
        self.waypoint_markers_circle.scale.y = 0.5
        self.waypoint_markers_circle.scale.z = 0.5
